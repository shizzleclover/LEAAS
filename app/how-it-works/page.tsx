        ...
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              How we help bring your project ideas to life, from concept to implementation.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <h2 className="text-3xl font-bold">A Collaborative Approach</h2>
              <p className="text-lg text-muted-foreground">
                We've developed a simple yet effective 4-step process to ensure your project is completed successfully while providing valuable learning opportunities along the way.
              </p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Initial discussion to understand your project requirements and technical goals.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Collaborative project roadmap with tech stack, features, and learning milestones.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Building your project together with regular knowledge-sharing sessions.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Project handover with comprehensive documentation and technical knowledge transfer.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1">
                <div className="space-y-6">
                  ...
                  <p className="text-lg text-muted-foreground">
                    The first step is understanding your project requirements, technical goals, and timeline.
                    We'll discuss:
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="h-5 w-5 text-primary mt-1" />
                      <span>Your project idea and technical requirements</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="h-5 w-5 text-primary mt-1" />
                      <span>Timeline and project milestones</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="h-5 w-5 text-primary mt-1" />
                    ...
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="h-5 w-5 text-primary mt-1" />
                      <span>Technical feasibility and learning opportunities</span>
                    </li>
                  </ul>
                  <p className="text-muted-foreground">
                    After the consultation, we'll provide a proposal with recommended package and development approach.
                  </p>
                </div>
              </div>
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Outline your project idea, requirements, and your technical experience level.
                        </p>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Have your desired completion date and key milestones ready.
                        </p>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Collect any relevant examples, similar projects, or specific technical requirements.
                        </p>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="font-medium">Identify Learning Goals</p>
                        <p className="text-sm text-muted-foreground">
                          Think about what skills or technologies you'd like to learn through this project.
                        </p>
                      </div>
                    </li>
                  </ul>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                  ...
                  <ul className="space-y-4">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Clear metrics for project success and technical learning objectives.
                        </p>
                      </div>
                    </li>
                  </ul>
              ...
              <div className="order-1">
                <div className="space-y-6">
                  ...
                  <p className="text-lg text-muted-foreground">
                    Once we've agreed on the scope, we'll create a collaborative project plan that includes:
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                    ...
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="h-5 w-5 text-secondary mt-1" />
                      <span>Feature breakdown and learning opportunities</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="h-5 w-5 text-secondary mt-1" />
                      <span>Resource allocation and mentorship approach</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="h-5 w-5 text-secondary mt-1" />
                      <span>Risk assessment and technical challenges</span>
                    </li>
                  </ul>
                  <p className="text-muted-foreground">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1">
                <div className="space-y-6">
                  ...
                  <p className="text-lg text-muted-foreground">
                    This is where we bring your project to life through collaborative development. Our process includes:
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="h-5 w-5 text-accent mt-1" />
                      <span>Agile development with regular knowledge-sharing</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="h-5 w-5 text-accent mt-1" />
                      <span>Weekly progress updates and interactive demos</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="h-5 w-5 text-accent mt-1" />
                      <span>Collaborative testing and technical reviews</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="h-5 w-5 text-accent mt-1" />
                      <span>Code documentation and educational comments</span>
                    </li>
                  </ul>
                  <p className="text-muted-foreground">
                    You'll be actively involved in the development process, gaining hands-on experience as the project evolves.
                  </p>
                </div>
              </div>
              <div className="order-1 lg:order-2">
                <Image
                  src="/network-development.png"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1">
                <div className="space-y-6">
                  ...
                  <p className="text-lg text-muted-foreground">
                    The final stage is delivering your completed project and ensuring you understand every aspect:
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="h-5 w-5 text-primary mt-1" />
                      <span>Complete codebase with comprehensive documentation</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="h-5 w-5 text-primary mt-1" />
                    ...
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="h-5 w-5 text-primary mt-1" />
                      <span>Code walkthrough and technical knowledge transfer</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="h-5 w-5 text-primary mt-1" />
                      <span>Project presentation and demonstration support</span>
                    </li>
                  </ul>
                  <p className="text-muted-foreground">
                    We ensure you understand your project thoroughly so you can confidently maintain and extend it.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="md:flex items-center md:justify-between">
                  <div className="md:w-1/2 md:pr-8 md:text-right">
                    <div className="brutalist-card p-4 md:ml-auto">
                      ...
                      <p className="text-muted-foreground">Final delivery, documentation, and technical knowledge transfer.</p>
                    </div>
                  </div>
                  <div className="absolute left-4 top-4 w-4 h-4 rounded-full bg-secondary md:left-1/2 md:-ml-2"></div>
                  <div className="md:w-1/2 md:pl-8 mt-4 md:mt-0"></div>
        ...
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-xl max-w-2xl mx-auto opacity-90">
              Let's start the conversation about turning your ideas into reality today.
            </p>
          </div>
