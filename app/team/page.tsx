...
const team = [
  {
    ...
    social: {
      ...
      linkedin: "#",
      github: "#",
      email: "mailto:murewa@leaas.com",
    },
  },
  {
    name: "Friend 1",
    role: "AI/ML Developer",
    bio: "Specialized in machine learning models, data analysis, and AI-powered applications for innovative products.",
    image: "/placeholder.svg?height=400&width=400",
    social: {
      twitter: "#",
      linkedin: "#",
      github: "#",
      email: "mailto:ai@leaas.com",
    },
  },
  {
    name: "Friend 2",
    ...
    social: {
      ...
      linkedin: "#",
      github: "#",
      email: "mailto:backend@leaas.com",
    },
  },
  {
    name: "Friend 3",
    ...
    social: {
      ...
      linkedin: "#",
      github: "#",
      email: "mailto:frontend@leaas.com",
    },
  },
]
        ...
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              We're a team of experienced developers dedicated to helping startups and businesses launch their innovative products.
            </p>
          </div>
      ...
      <section className="py-24 bg-muted">
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              We bring a diverse set of skills to help with any type of digital product.
            </p>
          </div>
      ...
      <section className="py-24">
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              The principles that guide our work and relationships with startups.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="brutalist-card p-6">
              ...
              <p className="text-muted-foreground">
                ...
                that exceed expectations and help startups achieve product success.
              </p>
            </div>
            ...
            <div className="brutalist-card p-6">
              ...
              <p className="text-muted-foreground">
                We believe in empowering startups through education. We don't just build products; we ensure startups
                understand their products and can confidently maintain and extend them.
              </p>
            </div>
        ...
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-xl max-w-2xl mx-auto opacity-90">
              Let our experienced team help you bring your product idea to life.
            </p>
          </div>
